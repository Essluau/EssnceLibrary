...
function Library:CreateWindow(config)
	...
	IconContainer.Size = UDim2.new(0, 30, 0, 26)
	IconContainer.BackgroundTransparency = 1
	IconContainer.LayoutOrder = 1
	IconContainer.ZIndex = 53
	IconContainer.Parent = ContentHolder

	local IconImg = Instance.new("ImageLabel")
	IconImg.Name = "Icon"
	IconImg.Size = UDim2.new(0, 36, 0, 44)
	IconImg.Position = UDim2.new(0.5, 0, 0.5, 0)
	IconImg.AnchorPoint = Vector2.new(0.5, 0.5)
	IconImg.BackgroundTransparency = 1
	IconImg.ScaleType = Enum.ScaleType.Fit
	IconImg.ZIndex = 54
	IconImg.Image = getIcon("https://raw.githubusercontent.com/Essluau/icons/refs/heads/main/IMG_4478-removebg-preview.png", "essnce_icon.png")
